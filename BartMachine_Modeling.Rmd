...
```{r}
posterior_probabilities_1 <- predict(bart_model_1, new_data = x_train_df_1, type = "prob")

posterior_intervals_1 <- quantile(posterior_probabilities_1, probs = c(0.025, 0.975))

posterior_intervals_1
...
```{r}
posterior_probabilities_2 <- predict(bart_model_2, new_data = x_train_df_2, type = "prob")

posterior_intervals_2 <- quantile(posterior_probabilities_2, probs = c(0.025, 0.975))

posterior_intervals_2
...
```{r}
posterior_probabilities_3 <- predict(bart_model_3, new_data = x_train_df_3, type = "prob")

posterior_intervals_3 <- quantile(posterior_probabilities_3, probs = c(0.025, 0.975))

posterior_intervals_3
...
```{r}
posterior_probabilities_4 <- predict(bart_model_4, new_data = x_train_df_4, type = "prob")

posterior_intervals_4 <- quantile(posterior_probabilities_4, probs = c(0.025, 0.975))

posterior_intervals_4
